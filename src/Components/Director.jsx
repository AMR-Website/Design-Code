  ...
  return (
    <Box>
      ...
      >
        <Box width={{ base: "100%", sm: "lg", lg: "xl" }} margin={"auto"}>
          ...
          >
            ...
            contracter use AMR to in Mining of iron ores [includes mining of
            hematite, magnetite, limonite, siderite or taconite etc
          </chakra.h2>
        </Box>
        <SimpleGrid
        color="black"
      ...
      >
        ...
        <Box w="70%" textAlign="left" margin="auto">
          <Text
            mt="20px"
            //
            ...
            lineHeight={"10"}
          >
            Our core team has in depth knowledge in Industrial construction,
            Mining and Irrigation sectors. The company has specialists with
            multiple competencies in Conceptualization, Planning, Designing,
            Executing and Delivering sustainable services to its clients.
            Central to our client’s prosperity and AMR India Limited’s success
            are, forwardthinking of top management, engineers, architects,
            planners, drafters, project managers, and support staff. They
            embrace values that have sustained the company since inception in
            its Excellence, Integrity, Accountability, Understanding and
            Responsibility
          </Text>
        </Box>
