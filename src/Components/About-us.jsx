      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text fontSize={'lg'}  color={"gray.500"} textAlign="left">
            ...
            Cements, Grasim Cements and other Mineral Enterprises along with
            various State and Central government irrigation projects.In the year
            2001, the company was incorporated into a Public Limited Company.
          </Text>
          <Stack
            spacing={{ base: 4, sm: 6 }}
